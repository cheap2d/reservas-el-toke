...
def obtener_horarios_disponibles(fecha):
    ...
    para la fecha indicada, y devuelve los slots tal como los devuelve la API.
    """
    # Definimos el rango completo del día (00:00 a 23:59:59Z)
...
def webhook():
    ...
    de salas y los slots disponibles para la fecha consultada.
    
    Si el mensaje contiene "disponibilidad" (opcionalmente seguido de un día, por ejemplo, "disponibilidad 09"),
    se consulta Bookeo para esa fecha; en caso contrario se usa la fecha actual.
    """
    ...
    if "disponibilidad" in incoming_msg:
        ...
        # Si se especifica un día numérico, se construye la fecha (ejemplo: "disponibilidad 09" → "2025-02-09")
